...
window.onload = function () {
  Particles.init({
    selector: '.background',
    color: ['#293034', '#a35a42', '#5d86a2'], // You can customize the colors
    connectParticles: true, // Connect the particles
    responsive: [
      {
        breakpoint: 768,
        options: {
...
function showSlides() {
  let slides = document.getElementsByTagName("li"); // Change to getElementsByTagName
